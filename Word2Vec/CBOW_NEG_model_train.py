...
from CBOW_NGE import InputData
import torch.optim as optim
from tqdm import tqdm
import argumentparser as argumentparser

args = argumentparser.CBOW_NGE_ArgumentParser()
...
if __name__ == '__main__':
    w2v = Word2Vec(input_file_name='text8.txt', output_file_name="cbow_neg.txt")
    w2v.train()
