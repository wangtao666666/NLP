...
from CBOW_HS import InputData
import torch.optim as optim
from tqdm import tqdm
import argumentparser as argumentparser

args = argumentparser.CBOW_HS_ArgumentParser()
...
class Word2Vec:
    def __init__(self, input_file_name, output_file_name):
        ...
        self.model = CBOWModel(self.data.word_count, EMB_DIMENSION).cpu()
        self.lr = LR
...
if __name__ == '__main__':
    w2v = Word2Vec(input_file_name='text8.txt', output_file_name="cbow_hs.txt")
    w2v.train()
